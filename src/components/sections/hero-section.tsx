  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto"> {/* Increased max-width */}
        ...
        <p className="mt-4 text-lg md:text-xl font-medium font-body text-gray-200 dark:text-gray-300 max-w-2xl mx-auto"> {/* Explicitly lighter text, adjusted mt */}
          Uniting Heritage, Empowering Future
        </p>
        <p className="mt-6 text-base md:text-lg font-lora text-gray-200 dark:text-gray-300 max-w-3xl mx-auto"> {/* Explicitly lighter text, adjusted mt */}
