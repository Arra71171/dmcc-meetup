  ...
  return (
    <section id="register" className="w-full max-w-6xl px-4">
      ...
      <p className={cn(
        ...
        Choose your pass and be part of this historic Meetei People's Convention.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 items-stretch">
        {tiers.map((tier) => (
          <GlassCard key={tier.name} className="flex flex-col p-6 md:p-8 h-full">
            ...
            <p className="font-body text-card-foreground/80 text-center mb-6 text-sm leading-relaxed flex-grow">
              {tier.description}
            </p>
