      ...
      <footer className="w-full py-12 mt-16 border-t border-foreground/10 bg-background">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="mt-4 font-lora text-xs text-muted-foreground space-y-1">
            <p>Contact: <a href="mailto:dmcc.office11@gmail.com" className="hover:underline">dmcc.office11@gmail.com</a> | Phone: <a href="tel:+919717921812" className="hover:underline">+91 9717921812</a></p>
